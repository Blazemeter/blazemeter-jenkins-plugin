...
/*
		...
		p.getPublishersList().add(
				new PerformancePublisher(0, 0, asList(new LoadReportParser(
						"*** / *
/
/*.jtl"))));
		...
		wc.getPage(b, "jenkins");
		wc
				.getPage(b,
						"jenkins/uriReport/test.jtl;Home.endperformanceparameter/");
*/	}
