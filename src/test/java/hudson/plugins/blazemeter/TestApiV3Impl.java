...
public class TestApiV3Impl {
    ...
    public void retrieveJUNITXML_null() {
        blazemeterApiV3 = new ApiV3Impl(null, TestConstants.mockedApiUrl,MockedAPI.proxyConfig);
    ...
    public void getTestInfo_NotFound() {
        blazemeterApiV3 = new ApiV3Impl("",TestConstants.mockedApiUrl,MockedAPI.proxyConfig);
    ...
    public void startTest_Retries() throws JSONException {
        ...
        HttpUtil spyWrapper = Mockito.spy(blazemeterApiV3.getBzmHttpWr());
